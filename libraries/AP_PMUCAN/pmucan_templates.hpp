...
#ifndef PMUCAN_UTIL_TEMPLATES_HPP_INCLUDED
#define PMUCAN_UTIL_TEMPLATES_HPP_INCLUDED
 ...
 */
template <bool Value>
struct PMUCAN_EXPORT StaticAssert;

template <>
struct PMUCAN_EXPORT StaticAssert<true>
{
    static void check() { }
};
 ...
 */
class PMUCAN_EXPORT Noncopyable
{
...
struct PMUCAN_EXPORT EnableIf { };

template <typename T>
struct PMUCAN_EXPORT EnableIf<true, T>
{
    typedef T Type;
};
...
struct PMUCAN_EXPORT EnableIfType
{
    typedef R Type;
};
...
struct PMUCAN_EXPORT Select;

template <typename TrueType, typename FalseType>
struct PMUCAN_EXPORT Select<true, TrueType, FalseType>
{
    typedef TrueType Result;
};

template <typename TrueType, typename FalseType>
struct PMUCAN_EXPORT Select<false, TrueType, FalseType>
{
...
#if PMUCAN_CPP_VERSION > PMUCAN_CPP03
template <typename T> struct RemoveReference<T&&> { typedef T Type; };
#endif
 ...
 * Value types
 */
template <bool> struct PMUCAN_EXPORT BooleanType { };
...
class PMUCAN_EXPORT IsImplicitlyConvertibleFromTo
{
...
struct PMUCAN_EXPORT CoerceOrFallbackImpl
{
 ...
 */
template <unsigned Value> struct PMUCAN_EXPORT CompileTimeIntSqrt;
template <> struct PMUCAN_EXPORT CompileTimeIntSqrt<1>   { enum { Result = 1  }; };
template <> struct PMUCAN_EXPORT CompileTimeIntSqrt<4>   { enum { Result = 2  }; };
template <> struct PMUCAN_EXPORT CompileTimeIntSqrt<9>   { enum { Result = 3  }; };
template <> struct PMUCAN_EXPORT CompileTimeIntSqrt<16>  { enum { Result = 4  }; };
template <> struct PMUCAN_EXPORT CompileTimeIntSqrt<25>  { enum { Result = 5  }; };
template <> struct PMUCAN_EXPORT CompileTimeIntSqrt<36>  { enum { Result = 6  }; };
template <> struct PMUCAN_EXPORT CompileTimeIntSqrt<49>  { enum { Result = 7  }; };
template <> struct PMUCAN_EXPORT CompileTimeIntSqrt<64>  { enum { Result = 8  }; };
template <> struct PMUCAN_EXPORT CompileTimeIntSqrt<81>  { enum { Result = 9  }; };
template <> struct PMUCAN_EXPORT CompileTimeIntSqrt<100> { enum { Result = 10 }; };
template <> struct PMUCAN_EXPORT CompileTimeIntSqrt<121> { enum { Result = 11 }; };
template <> struct PMUCAN_EXPORT CompileTimeIntSqrt<144> { enum { Result = 12 }; };
template <> struct PMUCAN_EXPORT CompileTimeIntSqrt<169> { enum { Result = 13 }; };
template <> struct PMUCAN_EXPORT CompileTimeIntSqrt<196> { enum { Result = 14 }; };
template <> struct PMUCAN_EXPORT CompileTimeIntSqrt<225> { enum { Result = 15 }; };
template <> struct PMUCAN_EXPORT CompileTimeIntSqrt<256> { enum { Result = 16 }; };
 ...
 */
template <typename T>
struct PMUCAN_EXPORT NumericTraits;

/// bool
template <>
struct PMUCAN_EXPORT NumericTraits<bool>
{
    enum { IsSigned = 0 };
    enum { IsInteger = 1 };
...
/// char
template <>
struct PMUCAN_EXPORT NumericTraits<char>
{
    enum { IsSigned = 1 };
    enum { IsInteger = 1 };
...
template <>
struct PMUCAN_EXPORT NumericTraits<signed char>
{
    enum { IsSigned = 1 };
    enum { IsInteger = 1 };
...
template <>
struct PMUCAN_EXPORT NumericTraits<unsigned char>
{
    enum { IsSigned = 0 };
    enum { IsInteger = 1 };
...
/// short
template <>
struct PMUCAN_EXPORT NumericTraits<short>
{
    enum { IsSigned = 1 };
    enum { IsInteger = 1 };
...
template <>
struct PMUCAN_EXPORT NumericTraits<unsigned short>
{
    enum { IsSigned = 0 };
    enum { IsInteger = 1 };
...
/// int
template <>
struct PMUCAN_EXPORT NumericTraits<int>
{
    enum { IsSigned = 1 };
    enum { IsInteger = 1 };
...
template <>
struct PMUCAN_EXPORT NumericTraits<unsigned int>
{
    enum { IsSigned = 0 };
    enum { IsInteger = 1 };
...
/// long
template <>
struct PMUCAN_EXPORT NumericTraits<long>
{
    enum { IsSigned = 1 };
    enum { IsInteger = 1 };
...
template <>
struct PMUCAN_EXPORT NumericTraits<unsigned long>
{
    enum { IsSigned = 0 };
    enum { IsInteger = 1 };
...
/// long long
template <>
struct PMUCAN_EXPORT NumericTraits<long long>
{
    enum { IsSigned = 1 };
    enum { IsInteger = 1 };
...
template <>
struct PMUCAN_EXPORT NumericTraits<unsigned long long>
{
    enum { IsSigned = 0 };
    enum { IsInteger = 1 };
...
/// float
template <>
struct PMUCAN_EXPORT NumericTraits<float>
{
    enum { IsSigned = 1 };
    enum { IsInteger = 0 };
...
/// double
template <>
struct PMUCAN_EXPORT NumericTraits<double>
{
    enum { IsSigned = 1 };
    enum { IsInteger = 0 };
...
/// long double
template <>
struct PMUCAN_EXPORT NumericTraits<long double>
{
    enum { IsSigned = 1 };
    enum { IsInteger = 0 };
...
#endif // PMUCAN_UTIL_TEMPLATES_HPP_INCLUDED

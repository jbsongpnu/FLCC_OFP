...
#ifndef PMUCAN_ERROR_HPP_INCLUDED
#define PMUCAN_ERROR_HPP_INCLUDED

#include "pmucan_build_config.hpp"
#include "pmucan_std.hpp"
 ...
 *  - If assertions are enabled (see PMUCAN_ASSERT()), aborts execution using zero assertion.
...
PMUCAN_EXPORT
// coverity[+kill]
void handleFatalError(const char* msg);*/ 	//commented by igpark


#endif // PMUCAN_ERROR_HPP_INCLUDED

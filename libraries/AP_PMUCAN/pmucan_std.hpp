...
#ifndef PMUCAN_STD_HPP_INCLUDED
#define PMUCAN_STD_HPP_INCLUDED

#include <AP_PMUCAN/pmucan_build_config.hpp> //#include <uavcan/build_config.hpp>
#include <cstdarg>
#include <cstddef>

#if !defined(PMUCAN_CPP_VERSION) || !defined(PMUCAN_CPP11)
...
#if !PMUCAN_USE_EXTERNAL_SNPRINTF

...
public:
    ...
    void init(uint8_t driver_index) override;	// JBSong (4.7.1: AP_CANDriver::init dropped enable_filters)
...
private:
    ...
    HAL_BinarySemaphore sem_handle;                                  // previously, HAL_EventHandle _event_handle;

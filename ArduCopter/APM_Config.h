...
#define USERHOOK_INIT userhook_init();                      // for code to be run once at startup // KAL : Activate for CAM
//#define USERHOOK_FASTLOOP userhook_FastLoop();            // for code to be run at 100hz
// #define USERHOOK_50HZLOOP userhook_50Hz();                  // for code to be run at 50hz
#define USERHOOK_MEDIUMLOOP userhook_MediumLoop();        // for code to be run at 10hz // KAL : Activate for CAM
